...
echo "export MANGO_BENCHER_DIR=$MANGO_BENCHER_DIR" >> exec-start-build-dependency-build.sh
echo "export MANGO_CONFIGUERE_DIR=$MANGO_CONFIGUERE_DIR" >> exec-start-build-dependency-build.sh
...
echo "export MANGO_BENCHER_DIR=$MANGO_BENCHER_DIR" >> exec-start-build-dependency-download.sh
echo "export MANGO_CONFIGUERE_DIR=$MANGO_CONFIGUERE_DIR" >> exec-start-build-dependency-download.sh
